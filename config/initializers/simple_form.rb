...
SimpleForm.setup do |config|
  ...
  config.wrappers :default, tag: 'div', class: 'mb-3', error_class: '', valid_class: '' do |b|
    b.use :html5
    b.use :placeholder
    ...
    b.use :input,
      class: 'appearance-none block w-full p-3 border border-gray-300 rounded shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm text-bold',
